package com.extramarks.assessment.apis.tests.GoToSchool;
...
import com.extramarks.assessment.apis.GoToSchool.GoToSchool;

import utils.TestBase;
import static io.qameta.allure.Allure.step;

public class GoToSchoolTest extends TestBase {

	@Test(timeOut = 10000, groups = { "smoke" })
	@Severity(SeverityLevel.CRITICAL)
	@Description("GoToSchool | Happy Flow")
	public void GoToSchoolTest_TC001() throws Exception {
		step("Creating object of main class");
		GoToSchool obj = new GoToSchool();
		...
		obj.getProperties().setProperty("action", "get_upcoming_schedule_v2_school");
		...
		obj.getProperties().setProperty("checksum", "5b018f08eb44ccb55218d059c3b8376e");
